...
func init() {
	common.Init("1.0.0", "2018", "Tool to clean a subversion controlled dir", "mpetavy", fmt.Sprintf("https://github.com/mpetavy/%s", common.Title()), common.APACHE, false, nil, nil, run, 0)
}
